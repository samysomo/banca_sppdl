...
const BankInfo = ({ account, account_id, type }: BankInfoProps) => {
  const router = useRouter();
  const searchParams = useSearchParams();

  const isActive = account_id === account?.account_id.toString();
  ...
  const colors = getAccountTypeColors(account?.account_type as AccountTypes);
